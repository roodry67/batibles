...
tipo: sesion
sesion: 1
fecha_real: 2023-12-09
fecha_ingame_inicio: 26/2
fecha_ingame_fin:
acto: "Acto 1 - Formación de los Batibles"
estado: reconstruida
resumen: Inicio del bloque de incorporación de los personajes actuales. El grupo se sitúa en [[Tilverton]], se presentan [[Daron]], [[Izzy]], [[el Badulaque]] y el [[Templo de Silvanus]].
fuentes:
...
Primera sesión de la campaña.

## Resumen
Inicio del bloque de incorporación de los personajes actuales. El grupo se sitúa en [[Tilverton]], se presentan [[Daron]], [[Izzy]], [[el Badulaque]] y el [[Templo de Silvanus]]. ^summary

## Log de sesion
- [[Bram]] y [[Lysara]] se incorporan a la campaña a nivel 3.  
...
- Encargo diplomático de [[Daron]] hacia [[Archenbridge]].
- Pista inicial sobre el [[templo de Oghma]] en [[Altaluna]].

## Pistas y preguntas

- ¿Qué información o pergaminos conserva el [[templo de Oghma]]?
- ¿Qué necesitan exactamente los [[los Amanecer|Amanecer]] para poder ayudar contra los rebeldes?

## Cambios para agenda

- Viajar a [[Altaluna]] para investigar el [[templo de Oghma]].
- Mantener como objetivo de fondo la misión diplomática hacia [[Archenbridge]].
