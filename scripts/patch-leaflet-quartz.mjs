...
var loadObsidianLeafletShapes = (mapName) => {
  ...
  },
  {
    ...
    to: `t(g,v),n.on("zoomend",()=>t(g,v))}function V(e){let n=JSON.parse(e);return Array.isArray(n)?n.filter(P):[]}function W(e,n){let t=V(e.points);if(t.length===0)return;let o={color:e.color};e.type==="polygon"?L.polygon(t,o).addTo(n):e.type==="polyline"&&L.polyline(t,o).addTo(n)}var c=class`,
  },
  {
